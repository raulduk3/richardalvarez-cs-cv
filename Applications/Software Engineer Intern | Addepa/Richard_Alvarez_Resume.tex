...
\resumeParagraph{Worked under Bernard Dickens III on strategies to protect against supply-chain attacks and ensure file integrity using advanced checksum technologies. Attended monthly code reviews, contributed 27 commits, and developed efficient data integrity verification scripts. Gained experience with data processing pipelines and research-driven engineering.}
...
\textbf{Frameworks}: Next.js, React, Tailwind CSS, Scikit-Learn, Keras, pandas, NumPy, Databricks, PySpark \\ \vspace{2pt}
...
\textbf{Systems \& Tools}: Linsux, shell scripting, AWS, DigitalOcean \\ \vspace{2pt}
